...
extern "C" {
#endif // __cplusplus
    extern void mandelbrot_ispc(const int32_t width, const int32_t height, const int32_t maxIter, const double xmin, const double xmax, const double ymin, const double ymax, uint8_t * image_data);
#if defined(__cplusplus) && (! defined(__ISPC_NO_EXTERN_C) || !__ISPC_NO_EXTERN_C )
} /* end extern C */
#endif // __cplusplus
