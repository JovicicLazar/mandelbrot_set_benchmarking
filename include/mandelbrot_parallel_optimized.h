//
// include/mandelbrot_parallel_optimized.h
...
extern "C" {
#endif // __cplusplus
    extern void mandelbrot_parallel_optimized(int32_t y, int32_t width, int32_t height, int32_t maxIter, double xmin, double xmax, double ymin, double ymax, uint8_t * rPlane, uint8_t * gPlane, uint8_t * bPlane);
#if defined(__cplusplus) && (! defined(__ISPC_NO_EXTERN_C) || !__ISPC_NO_EXTERN_C )
} /* end extern C */
#endif // __cplusplus
